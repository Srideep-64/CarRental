...
const Sidebar = () => {
  ...
  return (
    ...
    items-center pt-8 max-w-13 md:max-w-60 w-full border-r 
        ...
        <div className='group relative'>
            ...
            <label htmlFor="image">
                <img  src={ image ? URL.createObjectURL(image) : user?.image ||
                 "https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D"} alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' />
